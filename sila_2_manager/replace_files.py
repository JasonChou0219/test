...
# fdl_parser.py
copyfile(hugo_repository_path + '/user_script_env/SiLA_replacements/fdl_parser.py', sila2lib_path + '/fdl_parser/fdl_parser.py')
# command.py
copyfile(hugo_repository_path + '/user_script_env/SiLA_replacements/command.py', sila2lib_path + '/fdl_parser/command.py')
# data_base.py
copyfile(hugo_repository_path + '/user_script_env/SiLA_replacements/data_base.py', sila2lib_path + '/proto_builder/data/data_base.py')
# data_structure.py
copyfile(hugo_repository_path + '/user_script_env/SiLA_replacements/data_structure.py', sila2lib_path + '/proto_builder/data/data_structure.py')
# data_type_definition.py
copyfile(hugo_repository_path + '/user_script_env/SiLA_replacements/data_type_definition.py', sila2lib_path + '/fdl_parser/data_type_definition.py')
# data_type_parameter.py
copyfile(hugo_repository_path + '/user_script_env/SiLA_replacements/data_type_parameter.py', sila2lib_path + '/fdl_parser/data_type_parameter.py')
# type_base.py
copyfile(hugo_repository_path + '/user_script_env/SiLA_replacements/type_base.py', sila2lib_path + '/fdl_parser/type_base.py')
# type_basic.py
copyfile(hugo_repository_path + '/user_script_env/SiLA_replacements/type_basic.py', sila2lib_path + '/fdl_parser/type_basic.py')
